...
if LEAPFROG == True:
    ...
    file_name_base = "my_simulation_NVT_Langevin_tau1"   # file name for all output files using 
...
if LEAPFROG == True:
    ...
    file_name_base = "my_simulation_NVT_Langevin_tau0.1"   # file name for all output files using 
                                                    # Langevin integrator (BAOAB splitting) in NVT ensemble
...
temperature = 300       # K
box_length = 100        # nm
tau_thermostat = 0.01      # thermostat coupling constant in 1/ps
rij_min = 1e-2          # nm
NVT = True              # switch to decide between NVT and NVE
LEAPFROG = False        # switch to decide if the script uses the velocity Verlet or Leapfrog integrator
RSeed = True            # switch to decide if the random seed is used or not
...
if LEAPFROG == True:
    ...
    file_name_base = "my_simulation_NVT_Langevin_tau0.01"   # file name for all output files using 
                                                    # Langevin integrator (BAOAB splitting) in NVT ensemble
...
temperature = 300       # K
box_length = 100        # nm
tau_thermostat = 10      # thermostat coupling constant in 1/ps
rij_min = 1e-2          # nm
NVT = True              # switch to decide between NVT and NVE
LEAPFROG = False        # switch to decide if the script uses the velocity Verlet or Leapfrog integrator
RSeed = True            # switch to decide if the random seed is used or not
...
if LEAPFROG == True:
    ...
    file_name_base = "my_simulation_NVT_Langevin_tau10"   # file name for all output files using 
                                                    # Langevin integrator (BAOAB splitting) in NVT ensemble
...
temperature = 300       # K
box_length = 100        # nm
tau_thermostat = 100      # thermostat coupling constant in 1/ps
rij_min = 1e-2          # nm
NVT = True              # switch to decide between NVT and NVE
LEAPFROG = False        # switch to decide if the script uses the velocity Verlet or Leapfrog integrator
RSeed = True            # switch to decide if the random seed is used or not
...
if LEAPFROG == True:
    ...
    file_name_base = "my_simulation_NVT_Langevin_tau100"   # file name for all output files using 
                                                    # Langevin integrator (BAOAB splitting) in NVT ensemble
